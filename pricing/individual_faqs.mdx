...
We don’t offer a limited-time free trial, but our free plan lets you explore key features with no time limit.
...
Refunds are available in specific cases, such as technical issues preventing access. For details, see our [Refunds](/troubleshooting/refunds) page.
...
* If the issue persists, [contact support](https://exam-insights.com/help-and-resources/) and provide your receipt number (e.g., Receipt \#1234-5678) for reference.