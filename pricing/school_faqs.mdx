...
* **Single Subject License**: Covers only one selected subject per student or staff member.

* **All-Subjects License**: Grants access to all subjects across all departments.

Our pricing is designed so that if a student or staff member takes more than two subjects, an All-Subjects License provides better value.
...
We provide access code distribution for schools
