...
<CardGroup cols={2}>
  <Card title="Practice with real past exam questions" icon="question">
  ...
  <Card title="Track progress and improve faster" icon="chart-simple">
    The platform provides insights into strengths, weaknesses, and learning gaps, helping students refine their study strategies. With personalized performance tracking, students can monitor their progress and focus on the areas that need improvement.
  </Card>
