...
icon: "user-minus"
sidebarTitle: "Cancelling Your Plan"
...
* **For School Licences:** Schools can contact [support@exam-insights.com](mailto:support@exam-insights.com) for assistance if required.
