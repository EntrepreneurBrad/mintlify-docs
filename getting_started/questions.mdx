...
Keep track of your progress with a simple 5-level rating system. After reviewing the marking scheme, choose a rating that reflects how confident you feel about solving the question again.

These ratings help you:
* Filter questions based on past performance, so you can focus on areas that need improvement.
* Monitor your growth over time in the Performance page, giving you insights into your strengths and learning gaps.

With little effort, you’ll build a clear picture of your strengths and learning gaps, making it easier to target the areas that need the most attention.

For a detailed guide on how to get the most out of this feature, visit our Performance guide [here](/getting_started/performance).
