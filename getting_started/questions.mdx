...
Filters can be combined to get as specific as you need. You can:

* **Narrow down** – Want only “Calculate” questions at Hard difficulty? Select both to refine your search.

* **Expand results** – Need either Medium or Hard questions? The filter will include all matching questions.

* **Mix categories** – Looking for Topic 1 questions OR a specific Learning Objective? The filter treats these as separate groups and pulls in all relevant questions.
