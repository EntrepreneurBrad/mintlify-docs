...
<Note> This feature is available with a **Pro** plan. </Note>
...
<Note>
  This feature is **free**, but requires you to **have a free account**. It includes a **limited number** of queries per week. Upgrade to **Pro** for more.
</Note>
